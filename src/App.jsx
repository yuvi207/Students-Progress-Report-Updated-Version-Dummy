...
import { students } from "./studentsdetails";
import "./App.css";
function App() {
    ...
    <div>
      ...
      <form
        ...
        <div className="notice-board">
          <br />
            <h2>Progress report ஐ காண கீழே கொடுக்கப்பட்டுள்ள வழிமுறையைப் பின்பற்றவும்</h2>
            <h3>அன்பிற்கினிய பெற்றோருக்கு, வணக்கம்.</h3>
            <h4>தங்கள் மகன்/மகளின் மதிப்பெண் பட்டியலை மொபைலில் காணும் வழிமுறைகள்:</h4>
            <ul>
